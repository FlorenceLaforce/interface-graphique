...
class interface(tk.Tk):
    ...
    def creer_widgets(self):
        ...
        entry_num = tk.Entry(lbl_frm, width = 20)
        entry_num.grid(row=0, column=1, sticky="w", pady = 5)

        btn_chk = tk.Checkbutton(lbl_frm, text = "Gelé")
        btn_chk.grid(row=0, column=2, sticky="nsew", padx=10)

        entry_detenteur = tk.Entry(lbl_frm, width = 30)
        entry_detenteur.grid(row=1, column=1, columnspan=2, sticky="w", pady=5)
        ...
        btn_random = tk.Button(lbl_frm_montants, text = "Random", width=10)
        btn_random.grid(row=1, column=0, sticky="w", padx=10, pady=5)
        ...
        btn_depo = tk.Button(frm2, text = "Déposer", width=10)
        btn_depo.grid(row=0, column=0, padx=(10,40), pady=5)

        btn_retirer = tk.Button(frm2, text = "Retirer", width = 10)
        btn_retirer.grid(row=0, column=1, padx=40, pady=5)

        btn_vider = tk.Button(frm2, text="Vider", width=10)
        btn_vider.grid(row=0, column=2, padx=40, pady=5)

        btn_reset = tk.Button(frm2, text = "Reset", width=10)
        btn_reset.grid(row=0, column=3, padx=(40,10), pady=5)
